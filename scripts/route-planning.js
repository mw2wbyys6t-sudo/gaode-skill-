...
async function main() {
  ...
  try {
    ...
    switch (type) {
      case 'walking':
        result = await walkingRoute({ origin, destination, userRegion: args['user-region'] || args.userRegion });
      ...
      case 'driving':
        const drivingParams = { origin, destination, userRegion: args['user-region'] || args.userRegion };
        if (args.waypoints) {
      ...
      case 'riding':
        result = await ridingRoute({ origin, destination, userRegion: args['user-region'] || args.userRegion });
      ...
      case 'transfer':
        ...
        const transitParams = {
          ...
          destination,
          city: args.city,
          userRegion: args['user-region'] || args.userRegion,
